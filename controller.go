...
func onAdd(_ dynamic.Interface, screen io.Writer, pod *v1.Pod) {
	fmt.Fprintf(screen, "POD ADDED: name: %q namespace: %q\n", pod.Name, pod.Namespace)
}

func onModify(client dynamic.Interface, screen io.Writer, pod *v1.Pod) {
...
func onDelete(_ dynamic.Interface, screen io.Writer, pod *v1.Pod) {
